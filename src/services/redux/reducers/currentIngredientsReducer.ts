...
type TCurrentIngredientsState = {
  bun: TCurrentsIngredientItem | null
  all: TCurrentsIngredientItem[]
  order: number | null
}
...
export const currentIngredientsReducer = (state = initialState, action: TActionsAll): TCurrentIngredientsState => {
  switch (action.type) {
