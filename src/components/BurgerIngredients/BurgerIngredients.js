      ...
      <section className={styles.box}>
        ...
        <div className={`${styles.ingredientsBox}`} onScroll={onScrollIngredients}>
...

          {
            buns?.length > 0 &&
            <>
              <h2 className={`text text_type_main-medium`} ref={refTitleBuns}>Булки</h2>
...

          {
            sauce?.length > 0 &&
            <>
              <h2 className={`text text_type_main-medium`} ref={refSauceBuns}>Соусы</h2>
              <article className={`${styles.ingredients} pl-4 pr-4 pt-6 pb-10`}>
...

          {
            mains?.length > 0 &&
            <>
              <h2 className={`text text_type_main-medium`} ref={refMainsBuns}>Начинки</h2>
              <article className={`${styles.ingredients} pl-4 pr-4 pt-6 pb-10`}>
